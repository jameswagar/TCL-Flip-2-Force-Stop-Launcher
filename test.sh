...
javac -d "$BUILD" \
  ...
  "$ROOT/src/com/dumbphone/forcestop/LaunchLabelFormatter.java" \
  "$ROOT/src/com/dumbphone/forcestop/LaunchReasonParser.java" \
  "$ROOT/src/com/dumbphone/forcestop/LaunchReasonResolver.java" \
  ...
  "$ROOT/tests/com/dumbphone/forcestop/LaunchLabelFormatterTest.java" \
  "$ROOT/tests/com/dumbphone/forcestop/LaunchReasonParserTest.java" \
  "$ROOT/tests/com/dumbphone/forcestop/LaunchReasonResolverTest.java" \
...
java -cp "$BUILD" com.dumbphone.forcestop.LaunchLabelFormatterTest
java -cp "$BUILD" com.dumbphone.forcestop.LaunchReasonParserTest
java -cp "$BUILD" com.dumbphone.forcestop.LaunchReasonResolverTest
